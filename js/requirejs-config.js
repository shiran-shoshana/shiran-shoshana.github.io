...
var config = {
    map: {
        '*': {
            showMore: 'Amasty_ShopbyLite/js/custom/showMore',
...
var config = {
    config: {
        mixins: {
            'Magento_Swatches/js/swatch-renderer': {
                'Orbitvu_SelfHosted/js/swatch-renderer-mixin': true
            }
        }
    },
    map: {
        '*': {
            configurable:'Orbitvu_SelfHosted/js/configurable-mixin'
        }
    },
    paths: {
        "ovsh-namespace": "Orbitvu_SelfHosted/js/orbitvu-sh-public-namespace",
        "hammer": "Orbitvu_SelfHosted/js/orbitvu-sh-public-hammer",
        "hammer-jquery": "Orbitvu_SelfHosted/js/orbitvu-sh-public-hammer-jquery",
        "ovsh-gallery": "Orbitvu_SelfHosted/js/orbitvu-sh-public-gallery",
    },
};
require.config(config);
})();
...
var config = {
    paths: {
        swipeslider: "Worx_Banner/js/swiper.min",
        circletype: "Worx_Banner/js/circletype.min",
    },
    shim: {
        swipeslider: {
            deps: ['jquery']
...
var config = {
    map: {
        '*': {
            commonevents: 'Worx_Events/js/common',
        }
    },
    shim: {
        commonevents: {
